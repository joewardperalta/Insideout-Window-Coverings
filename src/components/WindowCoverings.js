...
export default function WindowCoverings() {
  return (
    // Product Introductory
    <div>
      <div className="bg-window-coverings bg-cover bg-center bg-no-repeat mb-14">
        <div className="container mx-auto pt-72 pb-24 text-white">
          <div className="w-1/2">
            <h2 className="text-4xl font-semibold uppercase mb-8">
              Window Coverings
            </h2>
            <p>
